...
def main():
    ...
    for i, channel in enumerate(predictions_per_channel.keys()):
        ...
        filtered_spindles = merge_and_filter_spindles(predictions_per_channel[channel])
